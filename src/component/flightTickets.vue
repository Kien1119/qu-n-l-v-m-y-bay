              ...
              <div class="flex flex-col card border-2 !border-gray-500 rounded-lg mx-5 my-5 gap-5">
                ...
                <div class="card flex gap-4 px-4 bg-slate-200 p-6 m-4 rounded-lg py-4">
                  <div class="flex-1 flex flex-col gap-1">
                    ...
                    <span class="h-6" style="color: #d81221">{{ errors.firstName }}</span>
                    ...
                    <span class="h-6" style="color: #d81221">{{ errors.titleName }}</span>
                  </div>
                  <div class="flex-1 flex flex-col gap-1">
                    <div>
                      <InputText
                    ...
                    <span class="h-6" style="color: #d81221">{{ errors.lastName }}</span>
                    <div>
                      <DatePicker
                    ...
                    <span class="h-6" style="color: #d81221">{{ errors.birthday }}</span>
                  </div>
                </div>
              </div>
            </div>
...
const { errors, handleSubmit, defineField } = useForm({
  validationSchema: yup.object({
    ...
    lastName: yup.string().required('Trường tên đệm Và tên bắt buộc'),
    titleName: yup.string().required('Trường tên đệm Và tên bắt buộc'),
    email: yup.string().required('example@gmail.com').email('Email không hợp lệ'),
    birthday: yup.string().required('Ngày là bắt buộc'),
